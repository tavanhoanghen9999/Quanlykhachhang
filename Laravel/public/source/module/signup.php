<?php
	...
	$sql_id = "select * from tbthanhvien WHERE iduser = '$id_user'";
	...
	if($checkuser>0)
		header("Location:../dangnhap.php?id_user=errorid");//echo "<br>tai khoan '$iduser' da ton tai";
	else if($demsdt>11)
		header("Location:../dangnhap.php?id_user=errorsdt");
	else if($pass!=$passre)
		header("Location:../dangnhap.php?id_user=errorpassre");
	else{
		$sql_insertid = "insert into tbthanhvien (hoten,diachi,email,sdt,iduser,pass,hieuluc)
