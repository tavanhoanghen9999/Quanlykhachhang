...
echo $id_hoadon;
//truyvansql hoadon
$sql_hd="SELECT * FROM tbhoadon WHERE idhoadon = '$id_hoadon'";
$data_hd = $o->query($sql_hd);
$arrHD = $data_hd->fetchAll();
//truyvansql cthd
$sql_cthd="SELECT thucankem.TENTHUCAN, chitietgoidoan.MATHUCAN, chitietgoidoan.idhoadon, chitietgoidoan.SOLUONG, chitietgoidoan.DONGIA FROM chitietgoidoan INNER JOIN thucankem ON chitietgoidoan.MATHUCAN = thucankem.MATHUCAN";
	...
	<body>
        ...
        <div class="container">
            <div class="center" align="center">        
                ...
                <span style="left: 35%;position:absolute"><b>Mã hóa đơn:</b></span><span style="right: 35%;position:absolute"><?php echo $v['idhoadon']; ?></span><br>
            ...
            <?php }?>
                ...
                foreach ($arrCTHD as $key => $value) {
                	if($value['idhoadon']==$id_hoadon){
                ?>
                    <span style="left: 37%;position:absolute"><i>+ <?php echo $value['TENTHUCAN']?></i><i style="color: red"> x<?php echo $value['SOLUONG'];?></i></span><span style="right: 35%;position:absolute"><?php
                    $tinhgia=$value['DONGIA']*$value['SOLUONG'];
